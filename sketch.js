...
function createCash() {
  if (World.frameCount % 120 == 0) {
   // Modify the positions of cash 
    var cash = createSprite(Math.round(random(120, 800),40, 10, 10));
...
function createDiamonds() {
  if (World.frameCount % 200 == 0) {
    ...
    var diamonds = createSprite(Math.round(random(120, 800),40, 10, 10));
...
function createJwellery() {
  if (World.frameCount % 280 == 0) {
    ...
    var jwellery = createSprite(Math.round(random(120, 800),40, 10, 10));
...
function createSword(){
  if (World.frameCount % 360 == 0) {
    ...
    var sword = createSprite(Math.round(random(120, 800),40, 10, 10));
    console.log
